...
import static ru.itis.meshy.android.contact.add.nearby.AddNearbyContactPermissionManager.areEssentialPermissionsGranted;
import static ru.itis.meshy.android.util.PermissionUtils.isLocationEnabledForBt;
import static ru.itis.meshy.android.util.UiUtils.handleException;
...
import ru.itis.meshy.android.contact.add.nearby.AddContactState.ContactExchangeFinished;
import ru.itis.meshy.android.contact.add.nearby.AddContactState.ContactExchangeResult.Error;
import ru.itis.meshy.android.contact.add.nearby.AddContactState.ContactExchangeResult.Success;
import ru.itis.meshy.android.contact.add.nearby.AddContactState.ContactExchangeStarted;
import ru.itis.meshy.android.contact.add.nearby.AddContactState.Failed;
import ru.itis.meshy.android.contact.add.nearby.AddContactState.Failed.WrongQrCodeType;
import ru.itis.meshy.android.contact.add.nearby.AddContactState.Failed.WrongQrCodeVersion;
import ru.itis.meshy.android.contact.add.nearby.AddContactState.KeyAgreementListening;
import ru.itis.meshy.android.contact.add.nearby.AddContactState.KeyAgreementStarted;
import ru.itis.meshy.android.contact.add.nearby.AddContactState.KeyAgreementWaiting;
import ru.itis.meshy.android.contact.add.nearby.AddContactState.QrCodeScanned;
import ru.itis.meshy.android.qrcode.QrCodeDecoder;
import ru.itis.meshy.android.qrcode.QrCodeUtils;

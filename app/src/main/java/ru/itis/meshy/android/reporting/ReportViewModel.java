...
import static ru.itis.meshy.android.logging.BriefLogFormatter.formatLog;
...
import ru.itis.meshy.android.logging.BriefLogFormatter;
import ru.itis.meshy.android.logging.CachingLogHandler;
import ru.itis.meshy.android.logging.LogDecrypter;
...
class ReportViewModel extends AndroidViewModel {
	...
	private final MeshyReportCollector collector;
	...
	ReportViewModel(@NonNull Application application,
		...
		super(application);
		collector = new MeshyReportCollector(application, networkUsageMetrics);

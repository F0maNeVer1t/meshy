...
import static ru.itis.messaging_engine.api.mailbox.MailboxConstants.API_CLIENT_TOO_OLD;
...
import static ru.itis.meshy.android.util.UiUtils.formatDate;
...
import ru.itis.meshy.android.view.MeshyButton;
...
public class MailboxStatusFragment extends Fragment {
	...
	public void onViewCreated(View v, @Nullable Bundle savedInstanceState) {
		...
		MeshyButton checkButton = v.findViewById(R.id.checkButton);

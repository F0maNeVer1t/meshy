...
import static ru.itis.meshy.android.MeshyApplication.ENTRY_ACTIVITY;
import static ru.itis.meshy.android.account.SetupViewModel.State.AUTHOR_NAME;
import static ru.itis.meshy.android.account.SetupViewModel.State.CREATED;
import static ru.itis.meshy.android.account.SetupViewModel.State.DOZE;
import static ru.itis.meshy.android.account.SetupViewModel.State.FAILED;
import static ru.itis.meshy.android.account.SetupViewModel.State.SET_PASSWORD;
import static ru.itis.meshy.android.util.UiUtils.setInputStateAlwaysVisible;
import static ru.itis.meshy.android.util.UiUtils.setInputStateHidden;

...
import static ru.itis.meshy.android.reporting.CrashReportActivity.EXTRA_APP_LOGCAT;
import static ru.itis.meshy.android.reporting.CrashReportActivity.EXTRA_APP_START_TIME;
import static ru.itis.meshy.android.reporting.CrashReportActivity.EXTRA_INITIAL_COMMENT;
import static ru.itis.meshy.android.reporting.CrashReportActivity.EXTRA_MEMORY_STATS;
import static ru.itis.meshy.android.reporting.CrashReportActivity.EXTRA_THROWABLE;
...
import ru.itis.meshy.android.reporting.FeedbackActivity;
import ru.itis.meshy.android.view.ArticleMovementMethod;
...
public class UiUtils {
	...
	public static SpannableStringBuilder getTeaser(Context ctx, Spanned text) {
		...
		ForegroundColorSpan fg = new ForegroundColorSpan(
				ContextCompat.getColor(ctx, R.color.meshy_text_link));

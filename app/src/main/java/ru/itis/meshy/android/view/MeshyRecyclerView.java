...
import static ru.itis.meshy.android.util.UiUtils.MIN_DATE_RESOLUTION;
...
public class MeshyRecyclerView extends FrameLayout {
	...
	public MeshyRecyclerView(Context context) {
		this(context, null, 0);
	}

	public MeshyRecyclerView(Context context, @Nullable AttributeSet attrs) {
	...
	public MeshyRecyclerView(Context context, @Nullable AttributeSet attrs,
		...
		TypedArray attributes = context.obtainStyledAttributes(attrs,
				R.styleable.MeshyRecyclerView);
		isScrollingToEnd = attributes
				.getBoolean(R.styleable.MeshyRecyclerView_scrollToEnd, true);
		int drawableRes = attributes
				.getResourceId(R.styleable.MeshyRecyclerView_emptyImage, -1);
		if (drawableRes != -1) setEmptyImage(drawableRes);
		String emtpyText =
				attributes.getString(R.styleable.MeshyRecyclerView_emptyText);
		if (emtpyText != null) setEmptyText(emtpyText);
		String emtpyAction =
				attributes.getString(R.styleable.MeshyRecyclerView_emptyAction);
	...
	private void initViews() {
		View v = LayoutInflater.from(getContext()).inflate(
				R.layout.meshy_recycler_view, this, true);

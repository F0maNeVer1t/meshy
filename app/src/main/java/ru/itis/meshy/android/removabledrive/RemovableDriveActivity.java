...
import ru.itis.meshy.android.removabledrive.RemovableDriveViewModel.Action;
import ru.itis.meshy.android.removabledrive.TransferDataState.TaskAvailable;
...
public class RemovableDriveActivity extends MeshyActivity {
	...
	private Fragment getSuccessFragment(Action action) {
		...
		return FinalFragment.newInstance(title,
				R.drawable.ic_check_circle_outline, R.color.meshy_brand_green,
				text);
	}

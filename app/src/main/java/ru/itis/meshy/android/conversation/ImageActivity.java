...
import static ru.itis.meshy.android.util.UiUtils.formatDateAbsolute;
...
import ru.itis.meshy.android.util.ActivityLaunchers.CreateDocumentAdvanced;
import ru.itis.meshy.android.util.MeshySnackbarBuilder;
import ru.itis.meshy.android.view.PullDownLayout;
...
public class ImageActivity extends MeshyActivity
	...
	private void showSaveImageDialog() {
		...
		Builder builder = new Builder(this, R.style.MeshyDialogTheme);
	...
	private void onImageSaveStateChanged(@Nullable Boolean error) {
		...
		int colorRes = error ?
				R.color.meshy_red_500 : R.color.meshy_primary;

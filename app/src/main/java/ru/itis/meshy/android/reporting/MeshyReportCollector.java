...
import static ru.itis.messaging_engine.util.AndroidUtils.getBluetoothAddressAndMethod;
import static ru.itis.messaging_engine.util.AndroidUtils.hasBtConnectPermission;
import static ru.itis.messaging_engine.util.PrivacyUtils.scrubInetAddress;
...
import ru.itis.meshy.android.reporting.ReportData.MultiReportInfo;
import ru.itis.meshy.android.reporting.ReportData.ReportItem;
import ru.itis.meshy.android.reporting.ReportData.SingleReportInfo;
import ru.itis.meshy.api.android.MemoryStats;
...
@Immutable
@NotNullByDefault
class MeshyReportCollector {

	private final Context ctx;
	private final NetworkUsageMetrics networkUsageMetrics;

	MeshyReportCollector(Context ctx, NetworkUsageMetrics networkUsageMetrics) {
		this.ctx = ctx;

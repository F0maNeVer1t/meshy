...
import static ru.itis.meshy.android.login.StartupViewModel.State.SIGNED_IN;
import static ru.itis.meshy.android.login.StartupViewModel.State.SIGNED_OUT;
import static ru.itis.meshy.android.login.StartupViewModel.State.STARTED;
import static ru.itis.meshy.android.login.StartupViewModel.State.STARTING;
...
import ru.itis.meshy.android.login.StartupViewModel.State;
...
public class StartupActivity extends BaseActivity implements
	...
	private void onStateChanged(State state) {
		if (state == SIGNED_OUT) {
			...
			startService(new Intent(this, MeshyService.class));

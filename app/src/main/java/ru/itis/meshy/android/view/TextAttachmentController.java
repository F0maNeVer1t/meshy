...
import ru.itis.meshy.android.attachment.AttachmentItemResult;
import ru.itis.meshy.android.attachment.AttachmentManager;
import ru.itis.meshy.android.attachment.AttachmentResult;
import ru.itis.meshy.android.view.ImagePreview.ImagePreviewListener;
...
public class TextAttachmentController extends TextSendController
	...
	public void showImageOnboarding(Activity activity) {
		int color = resolveColorAttribute(activity, androidx.appcompat.R.attr.colorControlNormal);
		...
		new MaterialTapTargetPrompt.Builder(activity,
				...
				.setBackgroundColour(getColor(activity, R.color.meshy_primary))

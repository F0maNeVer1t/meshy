...
public class ErrorWizardFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater,
		...
		int startColor =
				getColor(v.getContext(), R.color.meshy_accent);
	...
	public void onViewCreated(View v, @Nullable Bundle savedInstanceState) {
		...
		MeshyButton button3 = info3.findViewById(R.id.button3);
		MeshyButton button1_1_1 = info1.findViewById(R.id.button1_1_1);
		MeshyButton button1_1_2 = info1.findViewById(R.id.button1_1_2);
		...
		MeshyButton button1_1_3 = info1.findViewById(R.id.button1_1_3);
	...
	private void onUnlinkButtonClicked(View v) {
		...
		builder.setOnCancelListener(dialog -> ((MeshyButton) v).reset());
		builder.show();
	}

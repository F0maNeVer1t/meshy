...
import static ru.itis.meshy.android.util.UiUtils.enterPressed;
import static ru.itis.meshy.android.util.UiUtils.hideSoftKeyboard;
import static ru.itis.meshy.android.util.UiUtils.hideViewOnSmallScreen;
...
public class PasswordFragment extends BaseFragment implements TextWatcher {
	...
	private void onForgottenPasswordClick() {
		MaterialAlertDialogBuilder builder = new MaterialAlertDialogBuilder(
				requireContext(), R.style.MeshyDialogTheme);

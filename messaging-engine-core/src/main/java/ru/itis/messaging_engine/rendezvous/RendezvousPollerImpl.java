...
import ru.itis.messaging_engine.api.rendezvous.event.RendezvousConnectionClosedEvent;
import ru.itis.messaging_engine.api.rendezvous.event.RendezvousConnectionOpenedEvent;
...
import static ru.itis.messaging_engine.api.contact.PendingContactState.ADDING_CONTACT;
import static ru.itis.messaging_engine.api.contact.PendingContactState.FAILED;
...
import static ru.itis.messaging_engine.rendezvous.RendezvousConstants.POLLING_INTERVAL_MS;
import static ru.itis.messaging_engine.rendezvous.RendezvousConstants.RENDEZVOUS_TIMEOUT_MS;

...
import static ru.itis.messaging_engine.contact.ContactExchangeConstants.ALICE_KEY_LABEL;
import static ru.itis.messaging_engine.contact.ContactExchangeConstants.ALICE_NONCE_LABEL;
import static ru.itis.messaging_engine.contact.ContactExchangeConstants.BOB_KEY_LABEL;
import static ru.itis.messaging_engine.contact.ContactExchangeConstants.BOB_NONCE_LABEL;
import static ru.itis.messaging_engine.contact.ContactExchangeConstants.PROTOCOL_VERSION;
import static ru.itis.messaging_engine.contact.ContactExchangeConstants.SIGNING_LABEL;

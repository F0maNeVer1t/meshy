...
import ru.itis.messaging_engine.api.crypto.StreamDecrypter;
...
import static ru.itis.messaging_engine.api.transport.TransportConstants.FRAME_HEADER_LENGTH;
import static ru.itis.messaging_engine.api.transport.TransportConstants.FRAME_HEADER_PLAINTEXT_LENGTH;
import static ru.itis.messaging_engine.api.transport.TransportConstants.FRAME_NONCE_LENGTH;
import static ru.itis.messaging_engine.api.transport.TransportConstants.MAC_LENGTH;
import static ru.itis.messaging_engine.api.transport.TransportConstants.MAX_FRAME_LENGTH;
import static ru.itis.messaging_engine.api.transport.TransportConstants.MAX_PAYLOAD_LENGTH;
import static ru.itis.messaging_engine.api.transport.TransportConstants.PROTOCOL_VERSION;
import static ru.itis.messaging_engine.api.transport.TransportConstants.STREAM_HEADER_LENGTH;
import static ru.itis.messaging_engine.api.transport.TransportConstants.STREAM_HEADER_NONCE_LENGTH;
import static ru.itis.messaging_engine.api.transport.TransportConstants.STREAM_HEADER_PLAINTEXT_LENGTH;

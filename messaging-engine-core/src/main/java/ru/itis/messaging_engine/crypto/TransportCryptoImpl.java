...
import ru.itis.messaging_engine.api.transport.IncomingKeys;
import ru.itis.messaging_engine.api.transport.OutgoingKeys;
...
import static ru.itis.messaging_engine.api.transport.TransportConstants.ALICE_HANDSHAKE_HEADER_LABEL;
import static ru.itis.messaging_engine.api.transport.TransportConstants.ALICE_HANDSHAKE_TAG_LABEL;
import static ru.itis.messaging_engine.api.transport.TransportConstants.ALICE_HEADER_LABEL;
import static ru.itis.messaging_engine.api.transport.TransportConstants.ALICE_TAG_LABEL;
import static ru.itis.messaging_engine.api.transport.TransportConstants.BOB_HANDSHAKE_HEADER_LABEL;
import static ru.itis.messaging_engine.api.transport.TransportConstants.BOB_HANDSHAKE_TAG_LABEL;
import static ru.itis.messaging_engine.api.transport.TransportConstants.BOB_HEADER_LABEL;
import static ru.itis.messaging_engine.api.transport.TransportConstants.BOB_TAG_LABEL;
import static ru.itis.messaging_engine.api.transport.TransportConstants.CONTACT_ROOT_KEY_LABEL;
import static ru.itis.messaging_engine.api.transport.TransportConstants.PENDING_CONTACT_ROOT_KEY_LABEL;
import static ru.itis.messaging_engine.api.transport.TransportConstants.ROTATE_LABEL;
import static ru.itis.messaging_engine.api.transport.TransportConstants.STATIC_MASTER_KEY_LABEL;
import static ru.itis.messaging_engine.api.transport.TransportConstants.TAG_LENGTH;
import static ru.itis.messaging_engine.util.ByteUtils.INT_16_BYTES;
import static ru.itis.messaging_engine.util.ByteUtils.INT_64_BYTES;
import static ru.itis.messaging_engine.util.ByteUtils.MAX_16_BIT_UNSIGNED;
import static ru.itis.messaging_engine.util.ByteUtils.MAX_32_BIT_UNSIGNED;
import static ru.itis.messaging_engine.util.ByteUtils.writeUint16;
import static ru.itis.messaging_engine.util.ByteUtils.writeUint64;

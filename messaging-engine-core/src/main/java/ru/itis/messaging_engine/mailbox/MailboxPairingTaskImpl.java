...
import ru.itis.messaging_engine.api.mailbox.MailboxPairingState.ConnectionError;
import ru.itis.messaging_engine.api.mailbox.MailboxPairingState.InvalidQrCode;
import ru.itis.messaging_engine.api.mailbox.MailboxPairingState.MailboxAlreadyPaired;
import ru.itis.messaging_engine.api.mailbox.MailboxPairingState.Paired;
import ru.itis.messaging_engine.api.mailbox.MailboxPairingState.Pairing;
import ru.itis.messaging_engine.api.mailbox.MailboxPairingState.QrCodeReceived;
import ru.itis.messaging_engine.api.mailbox.MailboxPairingState.UnexpectedError;
...
import ru.itis.messaging_engine.mailbox.MailboxApi.ApiException;
import ru.itis.messaging_engine.mailbox.MailboxApi.MailboxAlreadyPairedException;
...
import static ru.itis.messaging_engine.api.mailbox.MailboxConstants.QR_FORMAT_VERSION;

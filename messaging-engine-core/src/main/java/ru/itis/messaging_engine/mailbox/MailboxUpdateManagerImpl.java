...
import ru.itis.messaging_engine.api.mailbox.MailboxSettingsManager.MailboxHook;
...
import ru.itis.messaging_engine.api.mailbox.event.MailboxPairedEvent;
import ru.itis.messaging_engine.api.mailbox.event.MailboxUnpairedEvent;
import ru.itis.messaging_engine.api.mailbox.event.MailboxUpdateSentToNewContactEvent;
import ru.itis.messaging_engine.api.mailbox.event.RemoteMailboxUpdateEvent;

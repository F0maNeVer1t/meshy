...
import static ru.itis.messaging_engine.api.plugin.WanTcpConstants.DEFAULT_PREF_PLUGIN_ENABLE;
import static ru.itis.messaging_engine.api.plugin.WanTcpConstants.ID;

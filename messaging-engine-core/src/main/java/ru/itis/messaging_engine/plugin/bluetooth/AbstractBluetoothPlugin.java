...
import ru.itis.messaging_engine.api.properties.event.RemoteTransportPropertiesUpdatedEvent;
...
import static ru.itis.messaging_engine.api.plugin.BluetoothConstants.DEFAULT_PREF_ADDRESS_IS_REFLECTED;
import static ru.itis.messaging_engine.api.plugin.BluetoothConstants.DEFAULT_PREF_EVER_CONNECTED;
import static ru.itis.messaging_engine.api.plugin.BluetoothConstants.DEFAULT_PREF_PLUGIN_ENABLE;
import static ru.itis.messaging_engine.api.plugin.BluetoothConstants.ID;
import static ru.itis.messaging_engine.api.plugin.BluetoothConstants.PREF_ADDRESS_IS_REFLECTED;
import static ru.itis.messaging_engine.api.plugin.BluetoothConstants.PREF_EVER_CONNECTED;
import static ru.itis.messaging_engine.api.plugin.BluetoothConstants.PROP_ADDRESS;
import static ru.itis.messaging_engine.api.plugin.BluetoothConstants.PROP_UUID;
import static ru.itis.messaging_engine.api.plugin.BluetoothConstants.UUID_BYTES;
...
import static ru.itis.messaging_engine.api.properties.TransportPropertyConstants.REFLECTED_PROPERTY_PREFIX;
import static ru.itis.messaging_engine.util.LogUtils.logException;
import static ru.itis.messaging_engine.util.PrivacyUtils.scrubMacAddress;
import static ru.itis.messaging_engine.util.StringUtils.isNullOrEmpty;
import static ru.itis.messaging_engine.util.StringUtils.macToBytes;
import static ru.itis.messaging_engine.util.StringUtils.macToString;

...
import static ru.itis.messaging_engine.api.data.BdfReader.DEFAULT_MAX_BUFFER_SIZE;
import static ru.itis.messaging_engine.api.data.BdfReader.DEFAULT_NESTED_LIMIT;

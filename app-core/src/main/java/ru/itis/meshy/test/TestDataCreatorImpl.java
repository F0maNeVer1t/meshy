...
import ru.itis.meshy.api.test.TestAvatarCreator;
import ru.itis.meshy.api.test.TestDataCreator;
...
import static ru.itis.messaging_engine.util.StringUtils.getRandomString;
...
import static ru.itis.meshy.test.TestData.AUTHOR_NAMES;
import static ru.itis.meshy.test.TestData.GROUP_NAMES;

...
import ru.itis.meshy.api.privategroup.GroupMember;
import ru.itis.meshy.api.privategroup.GroupMessage;
import ru.itis.meshy.api.privategroup.GroupMessageHeader;
import ru.itis.meshy.api.privategroup.JoinMessageHeader;
import ru.itis.meshy.api.privategroup.MessageType;
...
import ru.itis.meshy.api.privategroup.event.ContactRelationshipRevealedEvent;
import ru.itis.meshy.api.privategroup.event.GroupDissolvedEvent;
import ru.itis.meshy.api.privategroup.event.GroupMessageAddedEvent;
...
import static ru.itis.messaging_engine.api.sync.validation.IncomingMessageHook.DeliveryAction.ACCEPT_SHARE;
...
import static ru.itis.meshy.api.privategroup.Visibility.INVISIBLE;
import static ru.itis.meshy.api.privategroup.Visibility.REVEALED_BY_CONTACT;
import static ru.itis.meshy.api.privategroup.Visibility.REVEALED_BY_US;
import static ru.itis.meshy.api.privategroup.Visibility.VISIBLE;
import static ru.itis.meshy.privategroup.GroupConstants.GROUP_KEY_CREATOR_ID;
import static ru.itis.meshy.privategroup.GroupConstants.GROUP_KEY_DISSOLVED;
import static ru.itis.meshy.privategroup.GroupConstants.GROUP_KEY_MEMBERS;
import static ru.itis.meshy.privategroup.GroupConstants.GROUP_KEY_OUR_GROUP;
import static ru.itis.meshy.privategroup.GroupConstants.GROUP_KEY_VISIBILITY;
import static ru.itis.meshy.privategroup.GroupConstants.KEY_INITIAL_JOIN_MSG;
import static ru.itis.meshy.privategroup.GroupConstants.KEY_MEMBER;
import static ru.itis.meshy.privategroup.GroupConstants.KEY_PARENT_MSG_ID;
import static ru.itis.meshy.privategroup.GroupConstants.KEY_PREVIOUS_MSG_ID;
import static ru.itis.meshy.privategroup.GroupConstants.KEY_READ;
import static ru.itis.meshy.privategroup.GroupConstants.KEY_TIMESTAMP;
import static ru.itis.meshy.privategroup.GroupConstants.KEY_TYPE;

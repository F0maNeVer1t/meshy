...
import ru.itis.meshy.api.blog.BlogCommentHeader;
import ru.itis.meshy.api.blog.BlogFactory;
import ru.itis.meshy.api.blog.BlogManager;
import ru.itis.meshy.api.blog.BlogPost;
import ru.itis.meshy.api.blog.BlogPostFactory;
import ru.itis.meshy.api.blog.BlogPostHeader;
import ru.itis.meshy.api.blog.MessageType;
import ru.itis.meshy.api.blog.event.BlogPostAddedEvent;
...
import static ru.itis.meshy.api.blog.BlogConstants.KEY_AUTHOR;
import static ru.itis.meshy.api.blog.BlogConstants.KEY_COMMENT;
import static ru.itis.meshy.api.blog.BlogConstants.KEY_ORIGINAL_MSG_ID;
import static ru.itis.meshy.api.blog.BlogConstants.KEY_ORIGINAL_PARENT_MSG_ID;
import static ru.itis.meshy.api.blog.BlogConstants.KEY_PARENT_MSG_ID;
import static ru.itis.meshy.api.blog.BlogConstants.KEY_READ;
import static ru.itis.meshy.api.blog.BlogConstants.KEY_RSS_FEED;
import static ru.itis.meshy.api.blog.BlogConstants.KEY_TIMESTAMP;
import static ru.itis.meshy.api.blog.BlogConstants.KEY_TIME_RECEIVED;
import static ru.itis.meshy.api.blog.BlogConstants.KEY_TYPE;
import static ru.itis.meshy.api.blog.MessageType.COMMENT;
import static ru.itis.meshy.api.blog.MessageType.POST;
import static ru.itis.meshy.api.blog.MessageType.WRAPPED_COMMENT;
import static ru.itis.meshy.api.blog.MessageType.WRAPPED_POST;
import static ru.itis.meshy.api.identity.AuthorInfo.Status.NONE;

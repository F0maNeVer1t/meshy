...
import ru.itis.meshy.introduction.IntroduceeSession.Common;
import ru.itis.meshy.introduction.IntroduceeSession.Local;
import ru.itis.meshy.introduction.IntroduceeSession.Remote;
import ru.itis.meshy.introduction.IntroducerSession.Introducee;
...
import static ru.itis.messaging_engine.api.data.BdfDictionary.NULL_VALUE;
import static ru.itis.meshy.api.introduction.Role.INTRODUCEE;
import static ru.itis.meshy.api.introduction.Role.INTRODUCER;
import static ru.itis.meshy.introduction.IntroductionConstants.SESSION_KEY_ACCEPT_TIMESTAMP;
import static ru.itis.meshy.introduction.IntroductionConstants.SESSION_KEY_ALICE;
import static ru.itis.meshy.introduction.IntroductionConstants.SESSION_KEY_AUTHOR;
import static ru.itis.meshy.introduction.IntroductionConstants.SESSION_KEY_EPHEMERAL_PRIVATE_KEY;
import static ru.itis.meshy.introduction.IntroductionConstants.SESSION_KEY_EPHEMERAL_PUBLIC_KEY;
import static ru.itis.meshy.introduction.IntroductionConstants.SESSION_KEY_GROUP_ID;
import static ru.itis.meshy.introduction.IntroductionConstants.SESSION_KEY_INTRODUCEE_A;
import static ru.itis.meshy.introduction.IntroductionConstants.SESSION_KEY_INTRODUCEE_B;
import static ru.itis.meshy.introduction.IntroductionConstants.SESSION_KEY_INTRODUCER;
import static ru.itis.meshy.introduction.IntroductionConstants.SESSION_KEY_LAST_LOCAL_MESSAGE_ID;
import static ru.itis.meshy.introduction.IntroductionConstants.SESSION_KEY_LAST_REMOTE_MESSAGE_ID;
import static ru.itis.meshy.introduction.IntroductionConstants.SESSION_KEY_LOCAL;
import static ru.itis.meshy.introduction.IntroductionConstants.SESSION_KEY_LOCAL_TIMESTAMP;
import static ru.itis.meshy.introduction.IntroductionConstants.SESSION_KEY_MAC_KEY;
import static ru.itis.meshy.introduction.IntroductionConstants.SESSION_KEY_MASTER_KEY;
import static ru.itis.meshy.introduction.IntroductionConstants.SESSION_KEY_REMOTE;
import static ru.itis.meshy.introduction.IntroductionConstants.SESSION_KEY_REMOTE_AUTHOR;
import static ru.itis.meshy.introduction.IntroductionConstants.SESSION_KEY_REQUEST_TIMESTAMP;
import static ru.itis.meshy.introduction.IntroductionConstants.SESSION_KEY_ROLE;
import static ru.itis.meshy.introduction.IntroductionConstants.SESSION_KEY_SESSION_ID;
import static ru.itis.meshy.introduction.IntroductionConstants.SESSION_KEY_STATE;
import static ru.itis.meshy.introduction.IntroductionConstants.SESSION_KEY_TRANSPORT_KEYS;
import static ru.itis.meshy.introduction.IntroductionConstants.SESSION_KEY_TRANSPORT_PROPERTIES;

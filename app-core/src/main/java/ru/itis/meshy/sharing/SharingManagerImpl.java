...
import static ru.itis.meshy.sharing.MessageType.ABORT;
import static ru.itis.meshy.sharing.MessageType.ACCEPT;
import static ru.itis.meshy.sharing.MessageType.DECLINE;
import static ru.itis.meshy.sharing.MessageType.INVITE;
import static ru.itis.meshy.sharing.MessageType.LEAVE;
import static ru.itis.meshy.sharing.State.LOCAL_INVITED;
import static ru.itis.meshy.sharing.State.LOCAL_LEFT;
import static ru.itis.meshy.sharing.State.REMOTE_HANGING;
import static ru.itis.meshy.sharing.State.REMOTE_INVITED;
import static ru.itis.meshy.sharing.State.SHARING;
import static ru.itis.meshy.sharing.State.START;
